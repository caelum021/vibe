...
import { FONT_MONO, FONT_SERIF, SECTION_LABEL, DIVIDER, formatAge, getDocIcon, gitBadgeFor, gitStateLabel } from '../constants'
...
function ProjectDashboard({ data, brokenLinks, orphanDocs, graphData, onFileOpen, onRefresh, refreshing, justRefreshed, gitInfo }) {
